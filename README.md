...
_Note: there is a 1.7.0 Ambari early access in the v1.7.0-trunk branch. if you are interested in a particular Ambari version, always check for the appropriate branch._ 
